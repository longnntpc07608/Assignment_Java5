        ...
        <div class="form-container">
            ...
            <form action="/action_page.jsp" method="post">
                ...
                <div class="form-group">
                    ...
                    <label for="productCode">Tên thương hiệu:</label>
                ...
                <div class="form-group">
                    <label for="inventoryNumber">Số lượng sản phẩm:</label>
                    <input type="number" id="inventoryNumber" name="inventoryNumber" class="form-control" required>
                </div>
                <div class="form-group">
